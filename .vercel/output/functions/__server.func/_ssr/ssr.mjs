...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsXOokfH.mjs");
...
var manifest = { "bf4f87b00fb5df32aa351bc31caf5d5865ead446229428219e29a678d7875fac": {
	functionName: "sendTwilioSms_createServerFn_handler",
	importer: () => import("./sms-DSEuxiXv.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cj5fNga2.mjs").then((n) => n.t),
